...
public class SuperCircleView extends View {
    ...
    public SuperCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxCircleColor = a.getColor(R.styleable.SuperCircleView_max_circle_color, context.getResources().getColor(R.color.black));
        mRingNormalColor = a.getColor(R.styleable.SuperCircleView_ring_normal_color, context.getResources().getColor(R.color.theme_color));
