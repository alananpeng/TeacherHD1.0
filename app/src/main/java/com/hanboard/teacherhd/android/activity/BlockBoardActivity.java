...
public class BlockBoardActivity extends BaseActivity implements View.OnClickListener{
    ...
    class MySeekChangeListener implements SeekBar.OnSeekBarChangeListener{
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            Toast.makeText(me, "当前尺寸为" + seekBar.getProgress(),Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initDate() {
        ...
        dawingBoard = new DawingBoard(this, screenWidth + 300, screenHeight);
    ...
    public void showPaintColorDialog(View v) {
        AlertDialog.Builder alertDialgoBuilder = new AlertDialog.Builder(this, R.style.Dialog);
        alertDialgoBuilder.setTitle("选择画笔颜色：");
        //alertDialgoBuilder.setIconAttribute(R)
